...
const DashDefault = () => {
  useEffect(() => {
    const loginToastMessage = localStorage.getItem("loginToast");

    if (loginToastMessage) {
      toast.success(loginToastMessage, { position: "top-center" });
      localStorage.removeItem("loginToast"); // Remove it after showing
    }
  }, []);
  const tabContent = (
    <React.Fragment>
