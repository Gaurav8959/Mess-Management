      ...
      <Row>
        <Col>
          ...
          <Tabs variant="pills" defaultActiveKey="all-salary" className="mb-3 tab-pill-center">
            <Tab eventKey="all-salary" title="PAID-SALARY">
              <Col md={12} xl={12}>
                <Card className="Recent-Users widget-focus-lg">
                  <Card.Header>
                    <Card.Title as="h5">Paid Salary</Card.Title>
                  </Card.Header>
            ...
            <Tab eventKey="pay-salary" title="PAY-SALARY">
              <Col sm={12}>
                <Card>
                  <Card.Header>
                    <Card.Title as="h5">Pay Salary</Card.Title>
                  </Card.Header>
                  <Card.Body>
                    <Row>
                      <Col md={12}>
